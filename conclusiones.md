...
observa que países como México y Chile tienen mayor cantidad de empresas (Tabla 1),
...
Margen de beneficio neto muy alto. Descrito por países (Tabla 2), Perú tiene un ROE de
...
los indicadores del modelo DuPont (Figura 2) el ROE tiene muy baja o negativa correlación
